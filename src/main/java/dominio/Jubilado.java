 ...
 * @author Vanessa
 */
public class Jubilado implements Pensión {
...
public Jubilado(String nroCedula, String nombre, double salarioBase, int aniosAporte) {
...
public Jubilado(String nroCedula, String nombre, double pensionFial, String tipoJubilacion) {
    this.nroCedula = nroCedula;
        this.nombre = nombre;
